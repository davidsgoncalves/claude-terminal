...
pub fn write_scripts() -> Result<HookSetup, String> {
    ...
    write_executable(
        ...
        format!(
            "#!/bin/sh\n\
             # Generated by Claude Terminal. Adds this app's hooks to every run.\n\
             SHIM_DIR={shim_dir}\n\
